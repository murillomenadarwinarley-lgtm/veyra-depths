...
const COLOR_WALL := Color(0.75, 0.6, 1.0, 1.0)
const COLOR_CRYSTAL_HEART := Color(0.95, 0.95, 1.0, 1.0)
...
func _ready() -> void:
	...
	elif ability_id == "wall_jump":
		crystal.color = COLOR_WALL
	elif ability_id == "crystal_heart":
		crystal.color = COLOR_CRYSTAL_HEART
